...
#
# Time-stamp: <2021/05/30 22:21:27 (CST) daisuke>
#
...
# axes
ax.set_xlabel ('Relative Error of Proper Motion in RA [%]')
...
# plotting errors
ax.hist (data_pmra_err / data_pmra * 100.0, bins=100, range=x_range )
