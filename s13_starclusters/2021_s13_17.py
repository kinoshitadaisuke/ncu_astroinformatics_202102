...
#
# Time-stamp: <2021/05/30 23:20:55 (CST) daisuke>
#
...
parser = argparse.ArgumentParser (description='location of stars')
...
# plotting vectors
ax.plot (data_ra, data_dec, marker='o', markersize=2, color='black', \
         linestyle='none')
ax.quiver (data_ra, data_dec, data_pmra, data_pmdec, color='blue', angles='xy')

# saving file
fig.savefig (file_output, dpi=450, bbox_inches="tight")
