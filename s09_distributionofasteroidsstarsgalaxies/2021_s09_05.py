...
#
# Time-stamp: <2021/10/02 12:50:13 (CST) daisuke>
#
...
# output files
file_pdf = 'all_sky_bsc_gal_col.pdf'
file_png = 'all_sky_bsc_gal_col.png'
...
# plotting data
ax.set_title ('Bright Star Catalogue (galactic)', loc='right')
size = (8.0 - data_Vmag) * 5.0
colour = 2.0 - data_BV
for j in range ( len (colour) ):
    if (colour[j] < 0.0):
        colour[j] = 0.0
ax.scatter (data_l, data_b, s=size, c=colour, cmap=matplotlib.cm.Spectral, \
            marker='o', alpha=0.25)
