...
#
# Time-stamp: <2021/10/02 12:50:08 (CST) daisuke>
#
...
# output files
file_pdf = 'all_sky_bsc_gal.pdf'
file_png = 'all_sky_bsc_gal.png'
...
ax.scatter (data_l, data_b, s=size, c='blue', marker='o', alpha=0.3)
