...
#
# Time-stamp: <2021/10/02 12:46:42 (CST) daisuke>
#
...
# argument analysis
desc = 'weighted least-squares method using "curve_fit" of SciPy'
...
# weighted least-squares fitting using scipy.optimize.curve_fit
popt, pcov = scipy.optimize.curve_fit (func, data_x, data_y, p0=(a, b), \
                                       sigma=data_yerr)
...
# fitted line
fitted_x = numpy.linspace (-1.0, 16.0, 10**6)
...
# plotting a figure
ax.errorbar (data_x, data_y, yerr=data_yerr, fmt='c^', markersize=8, \
             ecolor='black', capsize=5, \
             label='synthetic data for least-squares method')
ax.plot (fitted_x, fitted_y, 'y-.', \
         label='weighted least-squares method by curve_fit')
ax.legend ()
